				...
				)
{
	...
	{
		Logger::m_info_log_file.open(info_log_filename.c_str(),ios::trunc);
	    Logger::m_warn_log_file.open(warn_log_filename.c_str(),ios::trunc);
	    Logger::m_error_log_file.open(error_log_filename.c_str(),ios::trunc);
	}
